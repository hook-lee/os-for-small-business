...
import { updateRoom, deleteRoom } from '@/lib/supabase/rooms'
...
export async function PATCH(
  ...
  try {
    const body = await req.json() as { name?: string; displayOrder?: number; isActive?: boolean }
    await updateRoom(id, body, ownerId)
