...
/**
 * 선(테두리)만 있는 아웃라인 아이콘 셋 (Lucide 스타일).
 * 컬러 이모지 대신 사용 → 모노톤·세련된 톤. 색은 currentColor라 부모 text-* 색을 따라감.
 * 사용처: Sidebar, MobileTabBar, NotificationBell.
 */
export type IconName =
  | 'home' | 'calendar' | 'users' | 'instructor' | 'wallet' | 'target'
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  bell: (
    <>
      ...
      <path d="M3.26 15.33a1 1 0 0 0 .85 1.67h15.78a1 1 0 0 0 .85-1.67C19.84 14.07 19 12.4 19 9a7 7 0 1 0-14 0c0 3.4-.84 5.07-1.74 6.33" />
    </>
  ),
  menu: (
    <>
